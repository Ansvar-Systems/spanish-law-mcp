...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Spanish Law MCP',
    version: context.version,
    jurisdiction: 'ES',
    description: 'Spanish Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Boletin Oficial del Estado (BOE)',
        url: 'https://www.boe.es',
        authority: 'Agencia Estatal Boletin Oficial del Estado',
      },
    ],
    freshness: {
